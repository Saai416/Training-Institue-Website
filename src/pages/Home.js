...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      <a href="https://wa.me/910000000000" className="whatsapp-floating pulse" target="_blank" rel="noreferrer">
        ...
        <div className="hero-content fade-in-up">
          <div className="hero-text glass-panel">
            ...
            <div className="hero-ctas">
              ...
              <a href="https://wa.me/910000000000" className="btn btn-secondary secondary-cta">Chat on WhatsApp</a>
            </div>
          </div>
        </div>
      </section>
